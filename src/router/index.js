...
const UserContent = () => import('@/views/accounts/UserContent');
const UserActivities = () => import('@/views/accounts/UserActivities');
const UserPosts = () => import('@/views/accounts/UserPosts');
const SettingsContent = () => import('@/views/settings/SettingsContent');
const Profile = () => import('@/views/settings/Profile');
const Post = () => import('@/views/settings/Post');
const Account = () => import('@/views/settings/Account');
const Password = () => import('@/views/settings/Password');
const SearchContent = () => import('@/views/search/SearchContent');
const Login = () => import('@/views/auth/Login');
const FeedBack = () => import('@/views/feedback/FeedBack');
const DljIndex = () => import('@/views/dwz/DljIndex');
const Dwztolong = () => import('@/views/dwz/Dwztolong');
